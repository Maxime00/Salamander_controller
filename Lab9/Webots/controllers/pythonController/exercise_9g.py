...
def exercise_9g(world, timestep, reset): 
    ...
    #with np.load(path+'logs/9g/simulation_'+str(i)+'.npz',allow_pickle=True) as data:
    
    with np.load(path+'logs/9g/simulation_0.npz',allow_pickle=True) as data:
