...
from exercise_9g2 import exercise_9g2
from exercise_9_extra import exercise_9_extra
...
def main():
    ...
    # Exercise 9g - Transition land-water
    if "9g1" in arguments:
        exercise_9g(world, timestep, reset)

    # Exercise 9g2 - Transition water-land
    if "9g2" in arguments:
        exercise_9g2(world, timestep, reset)
    
    if "9_extra" in arguments:
        exercise_9_extra(world, timestep, reset)
